...
// No forced login – let everyone view the community list
...
// Get user's communities (only if logged in)
$userCommunities = [];
...
.community-hub-wrapper {
    padding-top: 130px !important; /* Clears the fixed navbar */
}
...
/* Move title away from the left toggle */
.community-hub-title {
...
<div class="container-fluid py-4 community-hub-wrapper">
    <div class="row">
        <!-- Main Content -->
        <div class="col-lg-9">
            <!-- Header -->
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <!-- Title with left margin to avoid toggle -->
                    <h1 class="h3 fw-bold mb-0 community-hub-title">Community Hub</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <?php if (isLoggedIn() && isCommunityMember($community['id'], $userId)): ?>
...
<!-- Invite Modal (only for logged-in users) -->
<?php if (isLoggedIn()): ?>
